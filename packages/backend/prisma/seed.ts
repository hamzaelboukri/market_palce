import { PrismaClient, UserRole, AssetCategory, AssetStatus, PurchaseStatus } from '@prisma/client';
...
async function main() {
  ...
  const assets = [
    {
      ...
      sellerId: createdUsers[1].id, // Jane Smith
    ...
    },
    {
      ...
      price: 79.99,
      category: AssetCategory.CODE_SNIPPET,
      status: AssetStatus.ACTIVE,
      sellerId: createdUsers[1].id, // Jane Smith
    ...
    },
    {
      ...
      category: AssetCategory.CODE_SNIPPET,
      status: AssetStatus.ACTIVE,
      sellerId: createdUsers[3].id, // Mike Wilson
  ...
  const purchases = [
    {
      buyerId: createdUsers[0].id, // John Doe
      assetId: createdAssets[0].id, // UI Kit
      status: PurchaseStatus.PAID,
      amount: createdAssets[0].price,
    },
    {
      buyerId: createdUsers[0].id, // John Doe
      assetId: createdAssets[3].id, // Design System
      status: PurchaseStatus.PAID,
      amount: createdAssets[3].price,
    },
    {
      buyerId: createdUsers[4].id, // Sarah Jones
      assetId: createdAssets[1].id, // React Native Template
      status: PurchaseStatus.PAID,
      amount: createdAssets[1].price,
    },
    {
      buyerId: createdUsers[4].id, // Sarah Jones
      assetId: createdAssets[4].id, // Next.js Blog
      status: PurchaseStatus.PENDING,
      amount: createdAssets[4].price,
    },
    {
      buyerId: createdUsers[0].id, // John Doe
      assetId: createdAssets[5].id, // iOS Icons
      status: PurchaseStatus.PAID,
